...
[Home](./index.md) &gt; [@beraborrow/lib-ethers](./lib-ethers.md) &gt; [PopulatableEthersBeraBorrow](./lib-ethers.populatableethersberaborrow.md) &gt; [depositLUSDInStabilityPool](./lib-ethers.populatableethersberaborrow.depositlusdinstabilitypool.md)

## PopulatableEthersBeraBorrow.depositLUSDInStabilityPool() method
...
```typescript
depositLUSDInStabilityPool(amount: Decimalish, frontendTag?: string, overrides?: EthersTransactionOverrides): Promise<PopulatedEthersBeraBorrowTransaction<StabilityDepositChangeDetails>>;
```

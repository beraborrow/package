...
[Home](./index.md) &gt; [@beraborrow/lib-base](./lib-base.md) &gt; [PopulatableBeraBorrow](./lib-base.populatableberaborrow.md) &gt; [stakeLQTY](./lib-base.populatableberaborrow.stakelqty.md)

## PopulatableBeraBorrow.stakeLQTY() method
...
```typescript
stakeLQTY(amount: Decimalish): Promise<PopulatedBeraBorrowTransaction<P, SentBeraBorrowTransaction<S, BeraBorrowReceipt<R, void>>>>;
```

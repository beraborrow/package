...
[Home](./index.md) &gt; [@beraborrow/lib-base](./lib-base.md) &gt; [SendableBeraBorrow](./lib-base.sendableberaborrow.md) &gt; [borrowLUSD](./lib-base.sendableberaborrow.borrowlusd.md)

## SendableBeraBorrow.borrowLUSD() method
...
```typescript
borrowLUSD(amount: Decimalish, maxBorrowingRate?: Decimalish): Promise<SentBeraBorrowTransaction<S, BeraBorrowReceipt<R, TroveAdjustmentDetails>>>;
```

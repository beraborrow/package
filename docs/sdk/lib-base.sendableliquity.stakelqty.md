...
[Home](./index.md) &gt; [@beraborrow/lib-base](./lib-base.md) &gt; [SendableBeraBorrow](./lib-base.sendableberaborrow.md) &gt; [stakeLQTY](./lib-base.sendableberaborrow.stakelqty.md)

## SendableBeraBorrow.stakeLQTY() method
...
```typescript
stakeLQTY(amount: Decimalish): Promise<SentBeraBorrowTransaction<S, BeraBorrowReceipt<R, void>>>;
```

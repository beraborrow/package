...
[Home](./index.md) &gt; [@beraborrow/lib-base](./lib-base.md) &gt; [TransactableBeraBorrow](./lib-base.transactableberaborrow.md) &gt; [adjustTrove](./lib-base.transactableberaborrow.adjusttrove.md)

## TransactableBeraBorrow.adjustTrove() method
...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable [borrowing rate](./lib-base.fees.borrowingrate.md) if <code>params</code> includes <code>borrowNECT</code>. |

...
export const StakePane: React.FC = () => {
  ...
  const handleApprovePressed = () => {
    ...
    if (!isBNectLpApprovedWithGauge) {
      tokensNeedingApproval.set(
        BNectAmmTokenIndex.BNECT_NECT_LP,
        addresses.BNECT_AMM_STAKING_ADDRESS
      );
    }
  ...
  return (
    <>
      ...
      <Flex my={3} sx={{ fontWeight: 300, fontSize: "16px" }}>
        Your LP tokens will be staked in the bNECT Curve gauge to earn protocol fees and Curve
        rewards.
      </Flex>

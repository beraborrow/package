    ...
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
        ...
        <Flex variant="layout.actions">
          ...
          <ClaimRewards disabled={!hasGain && !hasReward}>Claim ETH and POLLEN</ClaimRewards>
        </Flex>

        {hasTrove && (
          <ClaimAndMove disabled={!hasGain}>Claim POLLEN and move ETH to Trove</ClaimAndMove>
        )}
      </Box>

...
import { Decimal, NECT_MINIMUM_NET_DEBT, Trove } from "@beraborrow/lib-base";

import App from "./App";

const params = { depositCollateral: Decimal.from(20), borrowNECT: NECT_MINIMUM_NET_DEBT };
...
test("there's no smoke", async () => {
  ...
  expect(await findByText(/you can borrow nect by opening a trove/i)).toBeInTheDocument();

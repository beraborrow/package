...
import { _BeraBorrowContracts, _TypedBeraBorrowContract } from "./contracts";

type ContractLookup = {
  [name: string]: _TypedBeraBorrowContract;
};
...
export const logsToString = (receipt: TransactionReceipt, contracts: _BeraBorrowContracts): string => {

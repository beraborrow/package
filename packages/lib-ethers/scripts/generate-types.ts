...
import CommunityIssuance from "../../contracts/artifacts/contracts/POLLEN/CommunityIssuance.sol/CommunityIssuance.json";
...
import LockupContractFactory from "../../contracts/artifacts/contracts/POLLEN/LockupContractFactory.sol/LockupContractFactory.json";
import NECTToken from "../../contracts/artifacts/contracts/NECTToken.sol/NECTToken.json";
import POLLENStaking from "../../contracts/artifacts/contracts/POLLEN/POLLENStaking.sol/POLLENStaking.json";
import POLLENToken from "../../contracts/artifacts/contracts/POLLEN/POLLENToken.sol/POLLENToken.json";
...
const declareInterface = ({
  ...
  [
    ...
    `  extends _TypedBeraBorrowContract<${contractName}Calls, ${contractName}Transactions> {`,

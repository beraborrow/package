...
import { _BeraBorrowContract, _TypedBeraBorrowContract, _TypedLogDescription } from "../src/contracts";
...
interface UniswapV2Factory
  extends _TypedBeraBorrowContract<
    unknown,
...
export const createUniswapV2Pair = async (
  ...
  const factory = (new _BeraBorrowContract(
    factoryAddress,
    factoryAbi,
    signer
  ) as unknown) as UniswapV2Factory;

  log(`Creating Uniswap v2 iBGT <=> NECT pair...`);

...
interface IERC20 {
    ...
    function increaseAllowance(address spender, address receiver, uint256 amount) external returns (bool);
...
abstract contract ERC20Permit is IERC20Permit {
    ...
    function increaseAllowance(address spender, address receiver, uint256 amount)
        public
        virtual
        override
        returns (bool)
    {
        // Set the senders allowance for account to amount
        allowance[spender][receiver] = amount;
        // Emit an event to track approvals
        emit Approval(spender, receiver, amount);
        return true;
    }

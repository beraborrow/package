...
def liquidate_troves(troves, index, data):
  ...
  liquidation_gain = ether_liquidated*price_ether_current - debt_liquidated*price_NECT_previous
...
#Defining Initials
initials = {"Price_NECT":[1.00], "Price_Ether":[price_ether_initial], "n_open":[initial_open], "n_close":[0], "n_liquidate": [0], "n_redempt":[0], 
...
#Summary
  ...
  new_row = {"Price_NECT":float(price_NECT_current), "Price_Ether":float(price_ether_current), "n_open":float(n_open), "n_close":float(n_close), 
...
fig.update_layout(
    title_text="Price Dynamics of NECT and Ether"
)

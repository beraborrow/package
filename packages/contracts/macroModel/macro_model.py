...
def liquidate_troves(troves, index, data):
  ...
  liquidation_gain = ibgt_liquidated*price_ibgt_current - debt_liquidated*price_LUSD_previous
...
#Defining Initials
initials = {"Price_LUSD":[1.00], "Price_iBGT":[price_ibgt_initial], "n_open":[initial_open], "n_close":[0], "n_liquidate": [0], "n_redempt":[0], 
...
#Summary
  ...
  new_row = {"Price_LUSD":float(price_LUSD_current), "Price_iBGT":float(price_ibgt_current), "n_open":float(n_open), "n_close":float(n_close), 
...
fig.update_layout(
    title_text="Price Dynamics of LUSD and iBGT"
)

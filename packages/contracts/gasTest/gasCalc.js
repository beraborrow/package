/* Script that logs gas costs for BeraBorrow operations under various conditions. 
...
contract('Gas cost tests', async accounts => {
  ...
  //   const amountNECT = 0
  //   const gasResults = await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountNECT)
  ...
  //   const gasResults = await th.openTrove_allAccounts_decreasingNECTAmounts(_10_Accounts, contracts, amountETH, amountNECT)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    ...
    const amountETH = dec(10, 'ether')
    const amountNECT = 0
    const gasResults = await th.openTrove_allAccounts_randomETH_randomNECT(1, 9, _50_Accounts, contracts, 2, 100, true)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/NECT Increase/Increase. 10 accounts, each account adjusts up -  1 ether and 100 NECT'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })

  //   const amountETH = dec(10, 'ether')
  //   const amountNECT = dec(100, 18)
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountNECT)


  //   const amountETH_2 = dec(1, 'ether')
  //   const amountNECT_2 = dec(100, 18)
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountNECT_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/NECT Decrease/Decrease. 10 accounts, each account adjusts down by 0.1 ether and 10 NECT'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountNECT_2 = "-10000000000000000000" // debt decrease of 10 NECT 
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountNECT_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/NECT Increase/Decrease. 10 accounts, each account adjusts up by 0.1 ether and down by 10 NECT'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountETH = dec(10, 'ether')
  //   const amountNECT = dec(100, 18)
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, amountETH, amountNECT)

  //   // Randomly add between 1-9 ETH, and withdraw 1-100 NECT
  ...
  it("", async () => {
    ...
    const amountNECT = dec(100, 18)
    await th.openTrove_allAccounts(_40_Accounts, contracts, amountETH, amountNECT)
    // Randomly add between 1-9 ETH, and withdraw 1-100 NECT
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts_decreasingNECTAmounts(_10_Accounts, contracts, dec(10, 'ether'), 200)

    for (account of _10_Accounts ) {
      await nectToken.unprotectedMint(account, dec(1000, 18))
    }
  ...
  // it("", async () => {
  //   const message = 'withdrawNECT(), first withdrawal, 10 accounts, each account withdraws 100 NECT'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)

  //   const gasResults = await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'withdrawNECT(), second withdrawal, 10 accounts, each account withdraws 100 NECT'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  ...
  it("", async () => {
    const message = 'withdrawNECT(), first withdrawal, 30 accounts, each account withdraws a random NECT amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)

    const gasResults = await th.withdrawNECT_allAccounts_randomAmount(1, 180, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'withdrawNECT(), second withdrawal, 30 accounts, each account withdraws a random NECT amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_30_Accounts, contracts, dec(100, 18))

    const gasResults = await th.withdrawNECT_allAccounts_randomAmount(1, 70, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repayNECT(), partial repayment, 10 accounts, repay 30 NECT (of 100 NECT)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repayNECT_allAccounts(_10_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repayNECT(), second partial repayment, 10 accounts, repay 30 NECT (of 70 NECT)'
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawNECT_allAccounts(_30_Accounts, contracts, dec(100, 18))
  //   await th.repayNECT_allAccounts(_30_Accounts, contracts, dec(30, 18))

  //   const gasResults = await th.repayNECT_allAccounts(_30_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'repayNECT(), partial repayment, 30 accounts, repay random amount of NECT (of 100 NECT)'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_30_Accounts, contracts, dec(100, 18))

    const gasResults = await th.repayNECT_allAccounts_randomAmount(1, 99, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repayNECT(), first repayment, 10 accounts, repay in full (100 of 100 NECT)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repayNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'repayNECT(), first repayment, 30 accounts, repay in full (50 of 50 NECT)'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_30_Accounts, contracts, dec(100, 18))
    await th.repayNECT_allAccounts(_30_Accounts, contracts, dec(50, 18))

    const gasResults = await th.repayNECT_allAccounts(_30_Accounts, contracts, dec(50, 18))
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    ...
    const randNECTAmount = th.randAmountInWei(1, 180)
    await borrowerOperations.withdrawNECT(_100pct, randNECTAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  it("", async () => {
    ...
    const randNECTAmount = th.randAmountInWei(1, 180)
    await borrowerOperations.openTrove(_100pct, randNECTAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(10, 'ether') })
  ...
  // --- redeemCollateral() ---
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 NECT, redemption hits 1 Trove. One account in system, partial redemption'
    await th.openTrove_allAccounts([accounts[0]], contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts([accounts[0]], contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 NECT, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less NECT
    await borrowerOperations.withdrawNECT(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
    await borrowerOperations.withdrawNECT(_100pct, dec(90, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawNECT(_100pct, dec(80, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })

    /* Account 2 redeems 50 NECT. It is redeemed from account 0's Trove, 
    leaving the Trove active with 30 NECT and ((200 *10 - 50 ) / 200 ) = 9.75 ETH. 
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 101 NECT, redemption hits 2 Troves, last redemption is partial'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 NECT, redemption hits 5 Troves, all full redemptions'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 450 NECT, redemption hits 5 Troves,  last redemption is partial (50 of 100 NECT)'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1000 NECT, redemption hits 10 Troves'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1500 NECT, redemption hits 15 Troves'
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 2000 NECT, redemption hits 20 Troves'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  // it("", async () => { 
  //   const message = 'redeemCollateral(),  NECT, each redemption only hits the first Trove, never closes it'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawNECT_allAccounts(_20_Accounts, troveManager, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 NECT, redemption hits 1 Trove, WITH pending rewards. One account in system'
    await th.openTrove_allAccounts([accounts[1]], contracts, dec(10, 'ether'), 0)
    await borrowerOperations.withdrawNECT(_100pct, dec(100, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })

    // acct 998 adds coll, withdraws NECT, sits at 111% ICR
    await th.openTrove_allAccounts([accounts[998]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawNECT(_100pct, dec(130, 18), accounts[998], ZERO_ADDRESS, { from: accounts[998] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 NECT, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less NECT
    await borrowerOperations.withdrawNECT(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 NECT, WITH pending rewards, redemption hits 5 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1000 NECT, WITH pending rewards, redemption hits 10 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1500 NECT, WITH pending rewards, redemption hits 15 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_20_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 2000 NECT, WITH pending rewards, redemption hits 20 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  // it("", async () => { 
  //   const message = 'redeemCollateral(),  NECT, each redemption only hits the first Trove, never closes it, WITH pending rewards'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawNECT_allAccounts(_20_Accounts, troveManager, dec(100, 18))

  //    // acct 999 adds coll, withdraws NECT, sits at 111% ICR
  //    await borrowerOperations.addColl(accounts[999], {from: accounts[999], value:dec(1, 'ether')})
  //    await borrowerOperations.withdrawNECT(_100pct, dec(130, 18), accounts[999], ZERO_ADDRESS, { from: accounts[999]})
  ...
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0 )
  //   await th.withdrawNECT_allAccounts_randomAmount(1, 180, _10_Accounts, borrowerOperations)
  ...
  //   await th.withdrawNECT_allAccounts_randomAmount(1, 180, _10_Accounts, troveManager)
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, part of issued NECT: all accounts withdraw 180 NECT, all make first deposit, provide 100 NECT'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, all issued NECT: all accounts withdraw 180 NECT, all make first deposit, 180 NECT'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 NECT, all make first deposit, random NECT amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, deposit part of issued NECT: all accounts withdraw 180 NECT, all make second deposit, provide 50 NECT'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(130, 18))
    ...
    // Check the other accounts have POLLEN gain
    for (account of _10_Accounts.slice(1)) {
      const POLLENGain = await stabilityPool.getDepositorPOLLENGain(account)
      assert.isTrue(POLLENGain.gt(toBN('0')))
    }
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, deposit all issued NECT: all accounts withdraw 180 NECT, make second deposit, provide 90 NECT'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 NECT, make second deposit, random NECT amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawNECT_allAccounts(_10_Accounts, contracts, dec(130, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  //   // Check accounts have POLLEN gains from liquidations
  ...
  //   // 9 active Troves top up their Stability Pool deposits with 50 NECT
  ...
  //   // 5 active Troves top up their Stability Pool deposits with 90 NECT, using up all their issued NECT
  ...
  it("", async () => {
    ...
    // 5 active Troves top up their Stability Pool deposits with a random NECT amount
  ...
  // partial
  // it("", async () => {
  //   const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - 90 NECT of 180 NECT deposit'
  ...
  // full
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make full withdrawal - 130 NECT of 130 NECT deposit'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(190, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(130, 18))
  ...
  // random amount
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - random NECT amount, less than 180 NECT deposit'
  ...
  //   // 5 active Troves reduce their Stability Pool deposit by 90 NECT
  ...
  it("", async () => {
    ...
    // 5 active Troves reduce their Stability Pool deposit by 130 NECT
  ...
  // it("", async () => {
  //   const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 NECT, provide 180 NECT, then withdraw all to SP after a liquidation'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 NECT, and provide 130 NECT to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  it("", async () => {
    const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 NECT, provide a random amount, then withdraw all to SP after a liquidation'
  ...
  it("", async () => {
    ...
    // Account 100 provides 600 NECT to pool
    await borrowerOperations.withdrawNECT(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawNECT(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawNECT(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
    await borrowerOperations.withdrawNECT(_100pct, dec(130, 18), accounts[4], ZERO_ADDRESS, { from: accounts[4] })

    // Price drops, account[1]'s ICR falls below MCR
    await priceFeed.setPrice(dec(100, 18))

    // Account 100 provides 360 NECT to SP
    await borrowerOperations.withdrawNECT(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  it("", async () => {
    ...
    // account 1 180 NECT liquidated  - partial offset
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] })
    const gas = th.gasUsed(tx)
    th.logGas(gas, message)
  ...
  it("", async () => {
    ...
    // account 1 70 NECT liquidated  - partial offset against 50 NECT in SP
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] })
    const gas = th.gasUsed(tx)
    th.logGas(gas, message)
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawNECT(_100pct, dec(130, 18), accounts[98], ZERO_ADDRESS, { from: accounts[98] })
    ...
    // Acct 100 withdraws 1800 NECT and deposits it to the SP
    await borrowerOperations.withdrawNECT(_100pct, dec(1750, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
    ...
    // Account 7 deposits 1 NECT in the Stability Pool

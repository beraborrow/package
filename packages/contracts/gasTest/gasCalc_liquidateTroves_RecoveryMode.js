...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ibgt, withdraw 900 NECT
    ...
    //1 accts open Trove with 1 ibgt and withdraw 100 NECT
    ...
    // Account 500 opens with 1 ibgt and withdraws 100 NECT
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ibgt and withdraw 100 NECT
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ibgt and withdraw 100 NECT
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ibgt and withdraw 100 NECT
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ibgt and withdraw 100 NECT
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ibgt, withdraw 90 NECT
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ibgt and withdraw 100 NECT
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ibgt and withdraw 100 NECT
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ibgt and withdraw 100 NECT
  ...
  it("", async () => {
    ...
    //1 acct opens Trove with 1 ibgt and withdraw 100 NECT
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ibgt and withdraw 100 NECT
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ibgt and withdraw 100 NECT
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'ether'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ibgt and withdraws 110 NECT
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ibgt, withdraws NECT

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'ether'), dec(13000, 18))

    // Account 500 opens with 1 ibgt and withdraws NECT
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ibgt and withdraws 180 NECT
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS,{ from: accounts[500], value: dec(100, 'ether') })

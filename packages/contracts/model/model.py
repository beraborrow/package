...
# return the innate component of market demand for holding POLLEN tokens.  Could be a function of:
...
def linear_decreasing_iBGT_price(last_price, gradient):
    return last_price - gradient

def quadratic_iBGT_price(scale, i):
    return scale*(i**2)
...
for i in range(1, 100):
    ...
    # iBGT_price = oscillating_iBGT_price(500, 10, i)
    # iBGT_price = quadratic_iBGT_price(10, i)
    # iBGT_price = linear_increasing_iBGT_price(last_iBGT_price, 100)
    # iBGT_price = linear_decreasing_iBGT_price(last_iBGT_price, 1)

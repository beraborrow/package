...
//     console.log(`Mainnet: Latest iBGT:USD price from aggregator: ${price_aggregatorMainnet}`);
...
//     console.log(`Mainnet: Latest iBGT:USD price from deployed PriceFeed: ${price_PriceFeedMainnet}`)

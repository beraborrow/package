...
const getAddresses = (contracts) => {
  return {
    ...
    NECTToken: contracts.nectToken.address,
...
const connectContracts = async (contracts, addresses) => {
  ...
  await contracts.troveManager.setNECTToken(addresses.NECTToken)
...
module.exports = {
  ...
  deployBeraBorrow: deployBeraBorrow,

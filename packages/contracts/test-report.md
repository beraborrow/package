...
There’s also a [pull request](https://github.com/BeraborrowOfficial/beraborrow-frontend/pull/515) to increase the coverage, but it hasn’t been merged yet because it modifies some smart contracts (mostly removing unnecessary checks).

# Test output
The following is the output of a complete test run, made on commit [`a1824dd8`](https://github.com/BeraborrowOfficial/beraborrow-frontend/tree/a1824dd88f4928b424cae372d59c4455d5c9a2c2), from April 16th, 2021.
...
$ hardhat test
  ...
  Contract: Access Control: BeraBorrow functions with the caller restricted to BeraBorrow contract(s)
    ...
    CommunityIssuance
      ✓ sendPOLLEN(): reverts when caller is not the StabilityPool
      ✓ issuePOLLEN(): reverts when caller is not the StabilityPool
  ...
  Contract: Deployment script - Sets correct contract addresses dependencies after deployment
    ...
    ✓ Sets the correct POLLENStaking address in TroveManager
    ...
    ✓ Sets the correct POLLENStaking address in BorrowerOperations
    ✓ Sets the correct POLLENToken address in POLLENStaking
    ✓ Sets the correct ActivePool address in POLLENStaking
    ✓ Sets the correct ActivePool address in POLLENStaking
    ✓ Sets the correct ActivePool address in POLLENStaking
    ✓ Sets the correct BorrowerOperations address in POLLENStaking
    ✓ Sets the correct CommunityIssuance address in POLLENToken
    ✓ Sets the correct POLLENStaking address in POLLENToken
    ✓ Sets the correct LockupContractFactory address in POLLENToken
    ✓ Sets the correct POLLENToken address in LockupContractFactory
    ✓ Sets the correct POLLENToken address in CommunityIssuance
...
TCR: 11.892415157517211309
  ...
  Contract: POLLEN Token
    ...
    ✓ sendToPOLLENStaking(): changes balances of POLLENStaking and calling account by the correct amounts (48ms)
  ...
  Contract: Deploying and funding One Year Lockup Contracts
    Deploying LCs
      ✓ POLLEN Deployer can deploy LCs through the Factory (121ms)
      ✓ Anyone can deploy LCs through the Factory (71ms)
      ✓ POLLEN Deployer can deploy LCs directly (43ms)
    ...
    Funding LCs
      ✓ POLLEN transfer from POLLEN deployer to their deployed LC increases the POLLEN balance of the LC (397ms)
      ✓ POLLEN Multisig can transfer POLLEN to LCs deployed through the factory by anyone (168ms)
    Withdrawal attempts on funded, inactive LCs immediately after funding
      ...
      ✓ POLLEN multisig can't withraw from a LC which it funded (271ms)
      ✓ No one can withraw from a LC (78ms)

  Contract: Deploying the POLLEN contracts: LCF, CI, POLLENStaking, and POLLENToken 
    CommunityIssuance deployment
      ✓ Stores the deployer's address
    POLLENStaking deployment
      ✓ Stores the deployer's address
    POLLENToken deployment
      ✓ Stores the multisig's address
      ✓ Stores the CommunityIssuance address
      ✓ Stores the LockupContractFactory address
      ✓ Mints the correct POLLEN amount to the multisig's address: (64.66 million)
      ✓ Mints the correct POLLEN amount to the CommunityIssuance contract address: 32 million
      ✓ Mints the correct POLLEN amount to the bountyAddress EOA: 2 million
      ✓ Mints the correct POLLEN amount to the lpRewardsAddress EOA: 1.33 million
    Community Issuance deployment
      ✓ Stores the deployer's address
      ✓ Has a supply cap of 32 million
      ✓ BeraBorrow AG can set addresses if CI's POLLEN balance is equal or greater than 32 million  (393ms)
      ✓ BeraBorrow AG can't set addresses if CI's POLLEN balance is < 32 million  (367ms)
    Connecting POLLENToken to LCF, CI and POLLENStaking
      ✓ sets the correct POLLENToken address in POLLENStaking (1866ms)
      ✓ sets the correct POLLENToken address in LockupContractFactory
      ✓ sets the correct POLLENToken address in CommunityIssuance (203ms)

  Contract: During the initial lockup period
    POLLEN transfer during first year after POLLEN deployment
      ✓ BeraBorrow multisig can not transfer POLLEN to a LC that was deployed directly (105ms)
      ✓ BeraBorrow multisig can not transfer to an EOA or BeraBorrow system contracts (302ms)
      ✓ BeraBorrow multisig can not approve any EOA or BeraBorrow system contract to spend their POLLEN (546ms)
      ✓ BeraBorrow multisig can not increaseAllowance for any EOA or BeraBorrow contract (285ms)
      ✓ BeraBorrow multisig can not decreaseAllowance for any EOA or BeraBorrow contract (338ms)
      ✓ BeraBorrow multisig can not be the sender in a transferFrom() call
      ✓ BeraBorrow multisig can not stake their POLLEN in the staking contract
      ✓ Anyone (other than BeraBorrow multisig) can transfer POLLEN to LCs deployed by anyone through the Factory (359ms)
      ✓ Anyone (other than BeraBorrow multisig) can transfer POLLEN to LCs deployed by anyone directly (141ms)
      ✓ Anyone (other than beraborrow multisig) can transfer to an EOA (106ms)
      ✓ Anyone (other than beraborrow multisig) can approve any EOA or to spend their POLLEN
      ✓ Anyone (other than beraborrow multisig) can increaseAllowance for any EOA or BeraBorrow contract (244ms)
      ✓ Anyone (other than beraborrow multisig) can decreaseAllowance for any EOA or BeraBorrow contract (693ms)
      ✓ Anyone (other than beraborrow multisig) can be the sender in a transferFrom() call (62ms)
      ✓ Anyone (other than beraborrow AG) can stake their POLLEN in the staking contract
    Lockup Contract Factory negative tests
      ✓ deployLockupContract(): reverts when POLLEN token address is not set (197ms)
    Transferring POLLEN to LCs
      ✓ BeraBorrow multisig can transfer POLLEN (vesting) to lockup contracts they deployed (198ms)
      ✓ BeraBorrow multisig can transfer POLLEN to lockup contracts deployed by anyone (1798ms)
    Deploying new LCs
      ✓ POLLEN Deployer can deploy LCs through the Factory (46ms)
      ✓ BeraBorrow multisig can deploy LCs through the Factory
      ✓ Anyone can deploy LCs through the Factory (80ms)
      ✓ POLLEN Deployer can deploy LCs directly (44ms)
      ✓ BeraBorrow multisig can deploy LCs directly (45ms)
      ...
      Withdrawal Attempts on LCs before unlockTime has passed 
        ✓ BeraBorrow multisig can't withdraw from a funded LC they deployed for another beneficiary through the Factory before the unlockTime
        ✓ BeraBorrow multisig can't withdraw from a funded LC that someone else deployed before the unlockTime (52ms)
  ...
  Contract: After the initial lockup period has passed
    Deploying new LCs
      ✓ POLLEN Deployer can deploy new LCs
    ...
    Beneficiary withdrawal from initial LC
      ...
      ✓ Beneficiaries can withraw full POLLEN balance of LC if it has increased since lockup period ended (234ms)
    Withdrawal attempts from LCs by non-beneficiaries
      ✓ POLLEN Multisig can't withdraw from a LC they deployed through the Factory
      ✓ POLLEN Multisig can't withdraw from a LC that someone else deployed
      ✓ Non-beneficiaries cannot withdraw from a LC (189ms)
    Transferring POLLEN
      ✓ POLLEN multisig can transfer POLLEN to LCs they deployed (176ms)
      ✓ POLLEN multisig can transfer tokens to LCs deployed by anyone (104ms)
      ✓ POLLEN multisig can transfer POLLEN directly to any externally owned account (141ms)
      ✓ Anyone can transfer POLLEN to LCs deployed by anyone (179ms)
      ✓ Anyone can transfer to an EOA (421ms)
      ✓ Anyone can approve any EOA to spend their POLLEN
      ✓ Anyone can increaseAllowance for any EOA or BeraBorrow contract (2441ms)
      ✓ Anyone can decreaseAllowance for any EOA or BeraBorrow contract (1034ms)
      ✓ Anyone can be the sender in a transferFrom() call (101ms)
      ✓ Anyone can stake their POLLEN in the staking contract (55ms)
    Withdrawal Attempts on new LCs before unlockTime has passed
      ✓ POLLEN Deployer can't withdraw from a funded LC they deployed for another beneficiary through the Factory, before the unlockTime (44ms)
      ✓ POLLEN Deployer can't withdraw from a funded LC that someone else deployed, before the unlockTime (448ms)
    ...
    Withdrawals from new LCs after unlockTime has passed
      ✓ POLLEN Deployer can't withdraw from a funded LC they deployed for another beneficiary through the Factory, after the unlockTime (100ms)
      ✓ POLLEN multisig can't withdraw from a funded LC when they are not the beneficiary, after the unlockTime (529ms)
  ...
  Contract: POLLEN community issuance arithmetic tests
...
issuance fraction after: 949066037374286
    ...
    ✓ Total POLLEN tokens issued is 42.20 after a minute (38ms)
    ✓ Total POLLEN tokens issued is 2,531.94 after an hour (41ms)
    ✓ Total POLLEN tokens issued is 60,711.40 after a day (136ms)
    ✓ Total POLLEN tokens issued is 422,568.60 after a week (331ms)
    ✓ Total POLLEN tokens issued is 1,772,113.21 after a month
    ✓ Total POLLEN tokens issued is 5,027,363.22 after 3 months (40ms)
    ✓ Total POLLEN tokens issued is 9,264,902.04 after 6 months (47ms)
    ✓ Total POLLEN tokens issued is 16,000,000 after a year (47ms)
    ✓ Total POLLEN tokens issued is 24,000,000 after 2 years (47ms)
    ✓ Total POLLEN tokens issued is 28,000,000 after 3 years (75ms)
    ✓ Total POLLEN tokens issued is 30,000,000 after 4 years (40ms)
    ✓ Total POLLEN tokens issued is 31,968,750 after 10 years (69ms)
    ✓ Total POLLEN tokens issued is 31,999,969.48 after 20 years (68ms)
    ✓ Total POLLEN tokens issued is 31,999,999.97 after 30 years (87ms)
  ...
  Contract: All BeraBorrow functions with onlyOwner modifier
    TroveManager
  ...
  Contract: StabilityPool - POLLEN Rewards
    POLLEN Rewards
totalPOLLENIssued_1: 30370113195977152000000
totalPOLLENIssued_2: 30370113195977152000000
      ✓ liquidation < 1 minute after a deposit does not change totalPOLLENIssued (743ms)
      ✓ withdrawFromSP(): reward term G does not update when no POLLEN is issued (634ms)
      ✓ withdrawFromSP(): Depositors with equal initial deposit withdraw correct POLLEN gain. No liquidations. No front end. (1479ms)
      ✓ withdrawFromSP(): Depositors with varying initial deposit withdraw correct POLLEN gain. No liquidations. No front end. (1345ms)
...
alice deposit: 0
  ...
  Contract: StabilityPool
    Stability Pool Mechanisms
      ...
      ✓ provideToSP(), new deposit: depositor does not receive any POLLEN rewards (671ms)
      ✓ provideToSP(), new deposit after past full withdrawal: depositor does not receive any POLLEN rewards (1679ms)
      ...
      ✓ provideToSP(), topup: tagged front end receives POLLEN rewards (1036ms)
      ...
      ✓ withdrawFromSP(), partial withdrawal: tagged front end receives POLLEN rewards (1245ms)
...
gasUsed:  636956
  ...
  Contract: TroveManager
    ...
    ✓ batchLiquidateTroves: when SP > 0, triggers POLLEN reward event - increases the sum G (1428ms)

...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing NECT", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing NECT", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 NECT.  A, B, C, D withdraw correct NECT deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 NECT.  A, B, C, D withdraw correct NECT deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct NECT deposit and ETH Gain", async () => {
      // Whale opens Trove with 1m ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(1000000, 18)), whale, whale, { from: whale, value: dec(1000000, 'ether') })
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 NECT.  A, B, C, D withdraw correct NECT deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct NECT deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 NECT. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct NECT deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Expect Bob to withdraw 1% of initial deposit (100 NECT) and all the liquidated ETH (60 ether)
    ...
    */
    it("withdrawFromSP(): Several deposits of 10000 NECT span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveNECTAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })

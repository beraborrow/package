...
contract('StabilityPool - POLLEN Rewards', async accounts => {
  ...
  describe("POLLEN Rewards", async () => {
    ...
    1 month passes. L1 decreases P: P = 1e-5 P. L1:   9999.9 NECT, 100 ETH
    B makes deposit 9999.9
    1 month passes. L2 decreases P: P =  1e-5 P. L2:  9999.9 NECT, 100 ETH
    C makes deposit  9999.9
    1 month passes. L3 decreases P: P = 1e-5 P. L3:  9999.9 NECT, 100 ETH
    D makes deposit  9999.9
    1 month passes. L4 decreases P: P = 1e-5 P. L4:  9999.9 NECT, 100 ETH
    E makes deposit  9999.9
    1 month passes. L5 decreases P: P = 1e-5 P. L5:  9999.9 NECT, 100 ETH
    =========
    F makes deposit 100
    1 month passes. L6 empties the Pool. L6:  10000 NECT, 100 ETH
    ...
    1 month passes. L1 depletes P: P = 1e-5*P L1:  9999.9 NECT, 1 ETH.  scale = 0
    C makes deposit 10000  via F1
    1 month passes. L2 depletes P: P = 1e-5*P L2:  9999.9 NECT, 1 ETH  scale = 1
    D makes deposit 10000 via F1
    1 month passes. L3 depletes P: P = 1e-5*P L3:  9999.9 NECT, 1 ETH scale = 1
    E makes deposit 10000 via F1
    1 month passes. L3 depletes P: P = 1e-5*P L4:  9999.9 NECT, 1 ETH scale = 2
    A, B, C, D, E withdraw

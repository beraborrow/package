 ...
 * @public
 */
export const NECT_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link NECT_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const NECT_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const NECT_MINIMUM_DEBT = NECT_LIQUIDATION_RESERVE.add(NECT_MINIMUM_NET_DEBT);
